(() => {
          ...
          var __webpack_modules__ = {
            686: function (
              ...
              var tiny_emitter_default =
                __nested_webpack_require_623__.n(tiny_emitter);
              ...
              var ClipboardActionCopy = function ClipboardActionCopy(target) {
                ...
                if ("string" === typeof target)
                  ...
                  !["text", "search", "url", "tel", "password"].includes(
                    null === target || void 0 === target ? void 0 : target.type
                  )
                )
            ...
            438: function (
              ...
              function delegate(
                ...
                if ("function" === typeof elements.addEventListener)
  ...
  (() => {
    "use strict";
    const flsModules = {};
    // Checking for webp support, adding webp or no-webp class to HTML ========================================================================================================================================================
        ...
        for (let i = 0, length = slides.length; i < length; i += 1) {
          ...
          if (params.slideShadows) {
            ...
            if (0 === $shadowBeforeEl.length)
              $shadowBeforeEl = create_shadow_createShadow(
                params,
                $slideEl,
                isHorizontal ? "left" : "top"
              );
            if (0 === $shadowAfterEl.length)
              $shadowAfterEl = create_shadow_createShadow(
                params,
                $slideEl,
    ...
    function initSliders() {
      if (document.querySelector(".image-preview__slider"))
        new core(".image-preview__slider", {
          slidesPerView: "auto",
          spaceBetween: 16,
        });
      if (document.querySelector(".house-slider"))
        new core(".house-slider", {
          modules: [Navigation],
          slidesPerView: "auto",
          spaceBetween: 40,
          navigation: {
            nextEl: ".house-slider__button-prev",
            prevEl: ".house-slider__button-next",
          },
        });
      if (document.querySelector(".villa-slider"))
        new core(".villa-slider", {
          modules: [Navigation],
          slidesPerView: "auto",
          spaceBetween: 40,
          navigation: {
            nextEl: ".villa-slider__button-prev",
            prevEl: ".villa-slider__button-next",
          },
        });
      if (document.querySelector(".apartment-slider"))
        new core(".apartment-slider", {
          modules: [Navigation],
          slidesPerView: "auto",
          spaceBetween: 40,
          navigation: {
            nextEl: ".apartment-slider__button-prev",
            prevEl: ".apartment-slider__button-next",
          },
        });
      let popupSlider;
      if (document.querySelector(".popup-slider"))
        popupSlider = new core(".popup-slider", {
          ...
          navigation: {
            nextEl: ".popup-swiper__button-prev",
            prevEl: ".popup-swiper__button-next",
          },
          on: {},
        });
      const images = document.querySelectorAll(".readySell__image img");
    ...
    // slider change in the 'Featured House' block ========================================================================================================================================================

    const buttons = document.querySelectorAll(".head-featuredHouse__button");
    const sliders = document.querySelectorAll(".body-featuredHouse__slider");
    const navigationBlocks = document.querySelectorAll(
      ".head-featuredHouse__navigation"
    );
    function updateActive(target) {
      buttons.forEach((button) => {
        if (button.id === target)
          button.classList.add("head-featuredHouse__button_current");
        else button.classList.remove("head-featuredHouse__button_current");
      });
      sliders.forEach((slider) => {
        if (slider.classList.contains(target + "-slider"))
          slider.classList.add("body-featuredHouse__slider_current");
        else slider.classList.remove("body-featuredHouse__slider_current");
      });
      navigationBlocks.forEach((navBlock) => {
        console.log(navBlock);
        if (navBlock.querySelector(`.${target}-slider__button-next`))
          navBlock.classList.add("head-featuredHouse__navigation_current");
        else
          navBlock.classList.remove("head-featuredHouse__navigation_current");
      });
    }
    document.addEventListener("click", (event) => {
      ...
      if (
        ...
        ("house" === targetId ||
          ...
          "apartment" === targetId ||
          "house-link" === targetId ||
          "apartment-link" === targetId ||
          "villa-link" === targetId)
      ) {
        event.preventDefault();
        const target = targetId.includes("-link")
          ? targetId.split("-link")[0]
          : targetId;
        updateActive(target);
      }
    });
    ...
    let buttonPlay = document.querySelector(".video");
    console.log(buttonPlay);
    document.addEventListener("click", function (event) {
      if (event.target === buttonPlay)
        buttonPlay.parentElement.innerHTML = `<iframe\n                    height="315"\n                    src="https://www.youtube.com/embed/6W53qbR7fsI?si=u-1s_-yW3efwiprB&amp;controls=0&mute=1"\n                    title="YouTube video player"\n                    frameborder="1"\n                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"\n                    referrerpolicy="strict-origin-when-cross-origin"\n                    allowfullscreen\n                    title="Demo video"\n                  ></iframe>`;
    });
    window["FLS"] = true;
    isWebp();
    spollers();
